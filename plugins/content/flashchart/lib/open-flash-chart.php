...
class open_flash_chart
{
	...
	{
		return $this->json_format($this->toString());
	}
...
class y_axis extends y_axis_base
{
	...
	function set_target_line($target)
	{
		$tmp = 'target_line';
		$this->$tmp = (float)$target;
	}

	function set_target_linecolor($colour)
	{
		$tmp = 'target-linecolor';
		$this->$tmp = $colour;
	}
...
class pie_value
{
	...
	function set_on_click($event)
	{
		$tmp = 'on-click';
		$this->$tmp = $event;
	}

	function set_key_on_click($action, $chart_id)
	{
		$tmp = 'key-on-click';
		$this->$tmp = $action;
		$tmp = 'chart-id';
...
class bar_base
{
	 ...
	 */
	function set_key($text, $size, $chart_id)
	{
		$this->text = $text;
		$tmp = 'font-size';
		$this->$tmp = $size;
...
class bar_simple extends bar_base
{

	function bar_simple()
	{
		$this->type = "bar_simple";
		parent::bar_base();
	}
}
...
class bar_plastic extends bar_base
{

	function bar_plastic()
	{
...
class bar_plastic_flat extends bar_base
{

	function bar_plastic_flat()
	{
...
class hbar
{
	...
	function set_label_colour($colour)
	{
		$this->label_colour = $colour;
	}

	function set_label_fontsize($size)
	{
		$this->label_fontsize = $size;
	}
...
class line_base
{
	...
	function set_key($text, $font_size, $chart_id)
	{
		$this->text = $text;
		$tmp = 'font-size';
		$this->$tmp = $font_size;
