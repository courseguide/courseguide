...
$this->form->loadFile( dirname(__FILE__) . DIRECTORY_SEPARATOR . "edit.xml"); // to load in our own version of login.xml
...
<form action="<?php echo JRoute::_('index.php?option=com_weblinks&view=form&w_id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="adminForm" class="form-validate">
	<fieldset>
		<legend><?php echo JText::_('COM_WEBLINKS_LINK'); ?></legend>
			...
			<button type="button" class="btn btn-small button" onclick="Joomla.submitbutton('weblink.save')">
				<?php echo JText::_('JSAVE') ?>
			</button>
			<button type="button" class="btn btn-small button" onclick="Joomla.submitbutton('weblink.cancel')">
